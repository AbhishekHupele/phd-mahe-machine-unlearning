...
\begin{center}
    ...
    % \Huge
    \textbf{Game-Theory-Based Balance: Formalizing the Machine Unlearning Problem as a Game Between Model Provider and Data Provider}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/mahe_logo.png}
    % \caption{Manipal Academy of Higher Education Logo}
    \end{figure}
    ...
    \textbf{Abhishek Hupele}

    Research Scholar-240900465
    ...
    \textbf{Dr. P.C. Siddalingaswamy}

    Associate Dean (Co-Guide)
    ...
    \textbf{Dr. Naveen Kulkarni}

    Director – Product Engineering - AI (Co-Guide)
